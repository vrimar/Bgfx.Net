...
//   DO NOT EDIT. Re-run build/run-generator.sh after a submodule bump.
// </auto-generated>

// <auto-generated> puts this file outside the project's nullable context.
#nullable enable
...
[Flags]
	public enum CapsVideoCodecFlags : uint
	{
		/// <summary>
...
[Flags]
	public enum VideoDecoderInitFlags : uint
	{
		/// <summary>
		/// No flags.
		/// </summary>
...
[Flags]
	public enum VideoDecodeFrameFlags : uint
	{
		/// <summary>
		/// No flags.
		/// </summary>
...
public unsafe struct Caps
	{
		...
		public fixed uint Formats[105];
		public fixed uint Codecs[3];
	}
...
public unsafe struct VideoDecoderInit
	{
		public uint Magic;
...
public unsafe struct VideoDecoderAu
	{
		public uint Size;
		public long PtsUs;
	}
...
public readonly partial struct DynamicIndexBufferHandle : IEquatable<DynamicIndexBufferHandle> {
    ...
    public DynamicIndexBufferHandle(ushort idx) { this.idx = idx; }
    ...
    public override int GetHashCode() => HashCode.Combine(idx);
...
public readonly partial struct DynamicVertexBufferHandle : IEquatable<DynamicVertexBufferHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public DynamicVertexBufferHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct FrameBufferHandle : IEquatable<FrameBufferHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public FrameBufferHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct IndexBufferHandle : IEquatable<IndexBufferHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public IndexBufferHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct IndirectBufferHandle : IEquatable<IndirectBufferHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public IndirectBufferHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct OcclusionQueryHandle : IEquatable<OcclusionQueryHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public OcclusionQueryHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct ProgramHandle : IEquatable<ProgramHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public ProgramHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct ShaderHandle : IEquatable<ShaderHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public ShaderHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct TextureHandle : IEquatable<TextureHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public TextureHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct UniformHandle : IEquatable<UniformHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public UniformHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct VertexBufferHandle : IEquatable<VertexBufferHandle> {
	    public readonly ushort idx;
	    public bool Valid => idx != UInt16.MaxValue;
    public VertexBufferHandle(ushort idx) { this.idx = idx; }
...
public readonly partial struct BufferHandle : IEquatable<BufferHandle> {
    ...
    public bool Equals(BufferHandle other) => idx == other.idx && Type == other.Type;
...
public static partial class Bgfx
{
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_attachment_init")]
		public static unsafe partial void AttachmentInit(Attachment* _this,TextureHandle _handle,Access _access,ushort _layer,ushort _numLayers,ushort _mip,byte _flags);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_view_rect")]
		public static unsafe partial void SetViewRect(ushort _id,short _x,short _y,ushort _width,ushort _height,float _minDepth,float _maxDepth);
	...
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_view_depth_bias")]
		public static unsafe partial void SetViewDepthBias(ushort _id,int _constant,float _slopeScale,float _clamp);
	...
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_view_sample_mask")]
		public static unsafe partial void SetViewSampleMask(ushort _id,uint _mask);
	...
	/// <param name="_mask">Sample coverage mask.</param>
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_encoder_set_sample_mask")]
		public static unsafe partial void EncoderSetSampleMask(Encoder* _this,uint _mask);
	...
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_encoder_set_depth_control")]
		public static unsafe partial ushort EncoderSetDepthControl(Encoder* _this,int _constant,float _slopeScale,float _clamp,[MarshalAs(UnmanagedType.U1)] bool _depthClamp);
	...
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_encoder_set_depth_control_cached")]
		public static unsafe partial void EncoderSetDepthControlCached(Encoder* _this,ushort _cache);
	...
	/// <param name="_num">Number of elements. Passing `UINT16_MAX` will use the _num passed on uniform creation.</param>
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_encoder_set_uniform_ref")]
		public static unsafe partial void EncoderSetUniformRef(Encoder* _this,UniformHandle _handle,void* _value,ushort _num);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_encoder_set_compute_index_buffer")]
		public static unsafe partial void EncoderSetComputeIndexBuffer(Encoder* _this,byte _stage,IndexBufferHandle _handle,Access _access,uint _offset,uint _size);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_encoder_set_compute_vertex_buffer")]
		public static unsafe partial void EncoderSetComputeVertexBuffer(Encoder* _this,byte _stage,VertexBufferHandle _handle,Access _access,uint _offset,uint _size);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_encoder_set_compute_dynamic_index_buffer")]
		public static unsafe partial void EncoderSetComputeDynamicIndexBuffer(Encoder* _this,byte _stage,DynamicIndexBufferHandle _handle,Access _access,uint _offset,uint _size);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_encoder_set_compute_dynamic_vertex_buffer")]
		public static unsafe partial void EncoderSetComputeDynamicVertexBuffer(Encoder* _this,byte _stage,DynamicVertexBufferHandle _handle,Access _access,uint _offset,uint _size);
	...
	/// <param name="_mask">Sample coverage mask.</param>
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_sample_mask")]
		public static unsafe partial void SetSampleMask(uint _mask);
	...
	/// <param name="_depthClamp">Disable depth clipping and clamp NDC depth to the [0,1] range instead.</param>
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_depth_control")]
		public static unsafe partial ushort SetDepthControl(int _constant,float _slopeScale,float _clamp,[MarshalAs(UnmanagedType.U1)] bool _depthClamp);
	...
	/// <param name="_cache">Index in depth control cache.</param>
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_depth_control_cached")]
		public static unsafe partial void SetDepthControlCached(ushort _cache);
	...
	/// <param name="_num">Number of elements. Passing `UINT16_MAX` will use the _num passed on uniform creation.</param>
	///
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_uniform_ref")]
		public static unsafe partial void SetUniformRef(UniformHandle _handle,void* _value,ushort _num);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_compute_index_buffer")]
		public static unsafe partial void SetComputeIndexBuffer(byte _stage,IndexBufferHandle _handle,Access _access,uint _offset,uint _size);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_compute_vertex_buffer")]
		public static unsafe partial void SetComputeVertexBuffer(byte _stage,VertexBufferHandle _handle,Access _access,uint _offset,uint _size);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_compute_dynamic_index_buffer")]
		public static unsafe partial void SetComputeDynamicIndexBuffer(byte _stage,DynamicIndexBufferHandle _handle,Access _access,uint _offset,uint _size);
	...
	[LibraryImport("bgfx", EntryPoint = "bgfx_set_compute_dynamic_vertex_buffer")]
		public static unsafe partial void SetComputeDynamicVertexBuffer(byte _stage,DynamicVertexBufferHandle _handle,Access _access,uint _offset,uint _size);
